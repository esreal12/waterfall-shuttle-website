...
export function InfoSection() {
  return (
    <section id="information" className="bg-brand-light py-20">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="space-y-8">
            <div className="rounded-2xl bg-white p-6 shadow-sm">
              <h3 className="font-display text-xl text-brand-deep">Schedules</h3>
            ...
            <div className="rounded-2xl bg-white p-6 shadow-sm">
              <h3 className="font-display text-xl text-brand-deep">Rates</h3>
          ...
          <div className="space-y-6">
            <div className="grid gap-6 md:grid-cols-2">
              <div className="rounded-2xl bg-white p-6 shadow-sm">
                <h3 className="font-display text-xl text-brand-deep">Manuel Antonio / Quepos</h3>
              ...
              <div className="rounded-2xl bg-white p-6 shadow-sm">
                <h3 className="font-display text-xl text-brand-deep">Uvita / Dominical</h3>
                <div className="mt-4 aspect-video overflow-hidden rounded-xl border border-brand-natural/20">
                  <iframe
            ...
            <div className="rounded-2xl bg-brand-deep p-6 text-white">
              <h3 className="font-display text-xl">Need a private schedule?</h3>
