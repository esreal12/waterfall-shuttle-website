export function ShuttleJourneySection() {
  return (
    <section id="journey" className="bg-white py-12 sm:py-16 md:py-20">
      <div className="container grid gap-8 lg:gap-12 lg:grid-cols-[minmax(0,0.65fr)_minmax(0,1.35fr)] lg:items-center">
        <div className="space-y-4 sm:space-y-5 order-2 lg:order-1">
          ...
          <ul className="list-disc space-y-2 sm:space-y-3 pl-4 sm:pl-5 text-xs sm:text-sm text-brand-charcoal/85">
        ...
        <div className="space-y-6 sm:space-y-8 order-1 lg:order-2">
          <div className="grid gap-4 sm:gap-6 sm:grid-cols-2">
            <div className="rounded-xl sm:rounded-2xl border border-brand-natural/20 bg-brand-light/80 p-4 sm:p-6 shadow-sm">
              <p className="text-xs font-semibold uppercase tracking-[0.28em] text-brand-natural">Duration</p>
              <p className="mt-2 sm:mt-3 font-display text-lg sm:text-xl lg:text-2xl text-brand-deep">~25 min ride</p>
              <p className="mt-1 sm:mt-2 text-xs sm:text-sm text-brand-charcoal/80">
                Enough time for a scenic drive and quick orientation before reaching the Nauyaca entrance.
              </p>
            </div>
            <div className="rounded-xl sm:rounded-2xl border border-brand-natural/20 bg-white p-4 sm:p-6 shadow-sm">
              <p className="text-xs font-semibold uppercase tracking-[0.28em] text-brand-natural">Comfort</p>
              <p className="mt-2 sm:mt-3 font-display text-lg sm:text-xl lg:text-2xl text-brand-deep">A/C & Wi-Fi</p>
              <p className="mt-1 sm:mt-2 text-xs sm:text-sm text-brand-charcoal/80">
          ...
          <div className="grid gap-3 sm:gap-4 sm:grid-cols-2">
            <div className="overflow-hidden rounded-xl sm:rounded-2xl shadow-sm">
              <img
                ...
                className="h-32 sm:h-40 md:h-48 w-full object-cover transition hover:scale-105"
              />
            </div>
            <div className="overflow-hidden rounded-xl sm:rounded-2xl shadow-sm">
              <img
